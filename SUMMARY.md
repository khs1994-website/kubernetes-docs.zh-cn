...
- Contribute
  ...
  - Style
    ...
    * [文档风格概述](contribute/style/_index.md)
    * [内容组织](contribute/style/content-organization.md)
    * [使用页面模板](contribute/style/page-templates.md)
...
- Tasks
  ...
  - Administer Cluster
    ...
    - Manage Resources
      ...
      * [为命名空间配置默认的CPU请求和限制](tasks/administer-cluster/manage-resources/cpu-default-namespace.md)
    ...
    - Network Policy Provider
      ...
      * [使用 Romana 作为 NetworkPolicy](tasks/administer-cluster/network-policy-provider/romana-network-policy.md)
      * [使用 Weave Net 作为 NetworkPolicy](tasks/administer-cluster/network-policy-provider/weave-network-policy.md)
    ...
    * [配置多个调度器](tasks/administer-cluster/configure-multiple-schedulers.md)
    ...
    * [命名空间演练](tasks/administer-cluster/namespaces-walkthrough.md)
    ...
    * [在实时集群上重新配置节点的 Kubelet](tasks/administer-cluster/reconfigure-kubelet.md)
    ...
    * [集群安全](tasks/administer-cluster/securing-a-cluster.md)
  ...
  - Debug Application Cluster
    ...
    * [调试 Pods 和 Replication Controllers](tasks/debug-application-cluster/debug-pod-replication-controller.md)
  ...
  - Inject Data Application
    ...
    * [通过文件将Pod信息呈现给容器](tasks/inject-data-application/downward-api-volume-expose-pod-information.md)
    * [通过环境变量将Pod信息呈现给容器](tasks/inject-data-application/environment-variable-expose-pod-information.md)
    * [使用 PodPreset 将信息注入 Pods](tasks/inject-data-application/podpreset.md)
  - Job
  ...
  - Run Application
    ...
    * [指定应用程序的中断预算（Disruption Budget）](tasks/run-application/configure-pdb.md)
    ...
    * [Horizontal Pod Autoscaler演练](tasks/run-application/horizontal-pod-autoscale-walkthrough.md)
    * [Pod 水平自动伸缩](tasks/run-application/horizontal-pod-autoscale.md)
    * [基于Replication Controller执行滚动升级](tasks/run-application/rolling-update-replication-controller.md)
    ...
    * [弹缩StatefulSet](tasks/run-application/scale-stateful-set.md)
  ...
  - Tls
    ...
    * [证书轮换](tasks/tls/certificate-rotation.md)
